	    ...
	    $('#tokenfield')
	 	...
	 	function llenarFormularios() {
	 	 ...
	 	 var data = Retornar2();
			...
			var string = '<table class="table" style="background-color: #FFFFFF;"><tbody><tr><td><b>Tecnologia Grafica:</b></td>'
			for ( i = 0; i< data["1"];i++) {
				string = string + '<td><label class="checkbox-inline"><input type="checkbox" id="1_' + (i+1) +'"> Seccion: ' + TransSeccion(i+1).toString() +' </label></td>';
			}
			string = string + '</tr><tr><td><b>Mecanica:</b></td>';
			for ( i = 0; i< data["2"];i++) {
				string = string + '<td><label class="checkbox-inline"><input type="checkbox" id="2_' + (i+1) +'"> Seccion: ' + TransSeccion(i+1).toString() +' </label></td>';
			}
			string = string + "</tr><tr><td><b>Electronica:</b></td>";
			for ( i = 0; i< data["3"];i++) {
				string = string + '<td><label class="checkbox-inline"><input type="checkbox" id="3_' + (i+1) +'"> Seccion: ' + TransSeccion(i+1).toString() +' </label>';
			}
			...
			string = string + "</tr><tr><td><b>Electronica:</b></td>";
			for ( i = 0; i< data["7"];i++) {
				string = string + '<td><label class="checkbox-inline"><input type="checkbox" id="7_' + (i+1) +'"> Seccion: ' + TransSeccion(i+1).toString() +' </label>';
			}
			string = string + "</tr><tr><td><b>Contabilidad:</b></td>";
			for ( i = 0; i< data["8"];i++) {
			...
			string = string + "</tr><tr><td><b>Electronica:</b></td>";
			for ( i = 0; i< data["11"];i++) {
				string = string + '<td><label class="checkbox-inline"><input type="checkbox" id="11_' + (i+1) +'"> Seccion: ' + TransSeccion(i+1).toString() +' </label>';
			}
			string = string + "</tr><tr><td><b>Contabilidad:</b></td>";
			for ( i = 0; i< data["12"];i++) {
