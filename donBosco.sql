...
-- Volcando datos para la tabla don_bosco.cursa: ~115 rows (aproximadamente)
...
-- Volcando datos para la tabla don_bosco.estudiante: ~115 rows (aproximadamente)
...
-- Volcando datos para la tabla don_bosco.periodo: ~1 rows (aproximadamente)
