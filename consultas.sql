...
CREATE TABLE secciones (ID int NOT NULL AUTO_INCREMENT, ano VARCHAR(6), curso VARCHAR(20), ano_escolar VARCHAR(10), secciones VARCHAR(2), eliminada BOOL NOT NULL DEFAULT '0', PRIMARY KEY (ID));
